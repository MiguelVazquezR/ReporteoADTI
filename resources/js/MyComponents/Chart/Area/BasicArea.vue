<template>
    <div id="chart">
        <apexchart class="text-[#165345]" type="area" :height="height" :options="chartOptions" :series="series" :width="width"></apexchart>
    </div>
</template>
...
export default {
    data() {
        return {
            ...
            //         enabled: false
            //     },
            //     labels: ['2024-08-01', '2024-08-02', '2024-08-03', '2024-08-04', '2024-08-05', '2024-08-06', '2024-08-07', '2024-08-08', '2024-08-09', '2024-08-10', '2024-08-11'], // Fechas de ejemplo
            //     xaxis: {
            //         type: 'datetime',
            //         title: {
